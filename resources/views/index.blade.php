...
<head>
    ...
    <!-- map-vector css -->
    <link rel="stylesheet" href="{{ asset('gradient/assets/css/plugins/jsvectormap.min.css') }}" />
    <!-- [Google Font : Poppins] -->
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="{{ route('dashboard') }}" class="b-brand text-primary">
                    <img src="{{ asset('gradient/assets/images/logojbg2.png') }}" alt="My Company Logo" class="logo-lg" style="height: 50px; width: auto;" />
                </a>
            </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('gradient/assets/images/widget/p1.jpg') }}" alt="prod img" class="img-fluid" /></td>
                                        <td>PNG002413</td>
                                        <td>Jane Elliott</td>
                                        <td>06-01-2017</td>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('gradient/assets/images/widget/p2.jpg') }}" alt="prod img" class="img-fluid" /></td>
                                        <td>PNG002344</td>
                                        <td>John Deo</td>
                                        <td>05-01-2017</td>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('gradient/assets/images/widget/p3.jpg') }}" alt="prod img" class="img-fluid" /></td>
                                        <td>PNG002653</td>
                                        <td>Eugine Turner</td>
                                        <td>04-01-2017</td>
                                    ...
                                    <tr>
                                        <td><img src="{{ asset('gradient/assets/images/widget/p4.jpg') }}" alt="prod img" class="img-fluid" /></td>
                                        <td>PNG002156</td>
