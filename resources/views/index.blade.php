...
<html lang="en">
  ...
  <head>
    ...
    <!-- [Favicon] icon -->
    <link rel="icon" href="/gradient/assets/images/favicon.svg" type="image/x-icon" />

    <!-- map-vector css -->
    <link rel="stylesheet" href="/gradient/assets/css/plugins/jsvectormap.min.css" />
    <!-- [Google Font : Poppins] icon -->
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600&display=swap" rel="stylesheet" />

    <!-- [Tabler Icons] https://tablericons.com   -->
    <link rel="stylesheet" href="/gradient/assets/fonts/tabler-icons.min.css" />
    <!-- [Feather Icons] https://feathericons.com   -->
    <link rel="stylesheet" href="/gradient/assets/fonts/feather.css" />
    <!-- [Font Awesome Icons] https://fontawesome.com/icons   -->
    <link rel="stylesheet" href="/gradient/assets/fonts/fontawesome.css" />
    <!-- [Material Icons] https://fonts.google.com/icons   -->
    <link rel="stylesheet" href="/gradient/assets/fonts/material.css" />
    <!-- [Template CSS Files] -->
    <link rel="stylesheet" href="/gradient/assets/css/style.css" id="main-style-link" />
    <link rel="stylesheet" href="/gradient/assets/css/style-preset.css" />
  ...
  <ul class="list-unstyled">
    <li class="dropdown pc-h-item header-user-profile">
      <a
        ...
        aria-expanded="false"
      >
        <img src="/gradient/assets/images/user/avatar-2.jpg" alt="user-image" class="user-avtar" />
      </a>
...
<!-- [ Header ] end -->
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card statistics-card-1">
              <div class="card-body">
                <img src="/gradient/assets/images/widget/img-status-4.svg" alt="img" class="img-fluid img-bg" />
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card statistics-card-1">
              <div class="card-body">
                <img src="/gradient/assets/images/widget/img-status-5.svg" alt="img" class="img-fluid img-bg" />
                <div class="d-flex align-items-center justify-content-between mb-3 drp-div">
          ...
          <div class="col-md-4 col-sm-12">
            <div class="card statistics-card-1 bg-brand-color-1">
              <div class="card-body">
                <img src="/gradient/assets/images/widget/img-status-6.svg" alt="img" class="img-fluid img-bg" />
                <div class="d-flex align-items-center justify-content-between mb-3 drp-div">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tr>
                      <td><img src="/gradient/assets/images/widget/p1.jpg" alt="prod img" class="img-fluid" /></td>
                      <td>PNG002413</td>
                      <td>Jane Elliott</td>
                      <td>06-01-2017</td>
                    ...
                    <tr>
                      <td><img src="/gradient/assets/images/widget/p2.jpg" alt="prod img" class="img-fluid" /></td>
                      <td>PNG002344</td>
                      <td>John Deo</td>
                      <td>05-01-2017</td>
                    ...
                    <tr>
                      <td><img src="/gradient/assets/images/widget/p3.jpg" alt="prod img" class="img-fluid" /></td>
                      <td>PNG002653</td>
                      <td>Eugine Turner</td>
                      <td>04-01-2017</td>
                    ...
                    <tr>
                      <td><img src="/gradient/assets/images/widget/p4.jpg" alt="prod img" class="img-fluid" /></td>
                      <td>PNG002156</td>
        ...
        <div class="row">
          ...
          <div class="col-sm-6 ms-auto my-1">
            <ul class="list-inline footer-link mb-0 justify-content-sm-end d-flex">
              <li class="list-inline-item"><a href="/gradient/index.html">Home</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <script src="/gradient/assets/js/plugins/apexcharts.min.js"></script>
    <script src="/gradient/assets/js/plugins/jsvectormap.min.js"></script>
    <script src="/gradient/assets/js/plugins/world.js"></script>
    <script src="/gradient/assets/js/plugins/world-merc.js"></script>
    <script src="/gradient/assets/js/pages/dashboard-sales.js"></script>
    <!-- [Page Specific JS] end -->
    <!-- Required Js -->
    <script src="/gradient/assets/js/plugins/popper.min.js"></script>
    <script src="/gradient/assets/js/plugins/simplebar.min.js"></script>
    <script src="/gradient/assets/js/plugins/bootstrap.min.js"></script>
    <script src="/gradient/assets/js/fonts/custom-font.js"></script>
    <script src="/gradient/assets/js/script.js"></script>
    <script src="/gradient/assets/js/theme.js"></script>
    <script src="/gradient/assets/js/plugins/feather.min.js"></script>
